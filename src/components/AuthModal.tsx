...
export default function AuthModal({
  ...
  const tAuth: Record<Language, Record<string, string>> = {
    es: {
      ...
      demoAccountBtn: 'Acceder con Usuario Demo (Simulado)',
      demoSubText: 'Prueba la plataforma de inmediato sin registrarte.'
    },
    en: {
      ...
      demoAccountBtn: 'Access with Demo User (Simulated)',
      demoSubText: 'Test the platform immediately without registering.'
    },
    pt: {
      ...
      demoAccountBtn: 'Acessar com Usuário de Demonstração',
      demoSubText: 'Teste o sistema imediatamente sem se registrar.'
    }
  };
